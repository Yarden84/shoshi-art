    ...
    >
      <div className="flex flex-col md:flex-row w-full max-w-6xl h-[70vh] shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-8 bg-white">
          <h2 className="uppercase tracking-widest text-gray-700 text-sm mb-4">About Me</h2>
          <p className="text-2xl md:text-3xl font-light text-gray-800 mb-8 leading-snug">
            Shoshi Haizler is a passionate artist who loves painting, drawing, and sculpting. Her work is inspired by the beauty of everyday life and the vibrant colors of nature. With years of experience and a unique artistic vision, Shoshi brings her creations to life in her studio.
          </p>
          <Link href="/about">
